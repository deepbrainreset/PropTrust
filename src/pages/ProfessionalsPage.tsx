...
import { ArrowLeft, BadgeCheck, Building2, Loader2, MapPin, Search, ShieldCheck, Star, UserRound } from 'lucide-react'
...
export function ProfessionalsPage(){
  ...
  useEffect(()=>{
    ...
    listVerifiedProfessionals().then(setRows).catch(err=>setError(err instanceof Error?err.message:'No se pudieron cargar profesionales.')).finally(()=>setLoading(false))
  },[])
  ...
  return <div className="page-shell">
    ...
    {!firebaseConfigured&&<div className="notice warning">Modo demo: todos los perfiles visibles son ficticios.</div>}
